...
#include "@VMODROOT/shaders/in_out.h" # # It should be generated with `v shader in_out.glsl`

fn C.in_out_shader_desc(gfx.Backend) &gfx.ShaderDesc // in_out name comes from the name specified in the shader in @program
...
fn init(mut app App) {
	...
	shader := gfx.make_shader(C.in_out_shader_desc(gfx.query_backend()))
